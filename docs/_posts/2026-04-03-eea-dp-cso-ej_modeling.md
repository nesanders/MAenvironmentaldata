...
The plots below show the posterior probability distribution of the dependence measurement *&beta;* for each EJ indicator, transformed as {% raw %}$$2^\beta$${% endraw %} to represent the growth of the dependent variable corresponding to a 2x increase in the independent variable.

![figure](/assets/figures/MAEEADP_through_2025_Watershed_stanfit_beta_LINGISOPCT.png)
![figure](/assets/figures/MAEEADP_through_2025_Watershed_stanfit_beta_LOWINCPCT.png)
![figure](/assets/figures/MAEEADP_through_2025_Watershed_stanfit_beta_MINORPCT.png)
