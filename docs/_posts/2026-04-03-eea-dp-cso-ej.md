...
**The rainfall-discharge relationship is weaker than expected, and dry-weather discharges warrant further investigation.** While CSO discharge is expected to increase markedly with rainfall, approximately 34% of days with zero or minimal prior rainfall still report discharges. These dry-weather events violate EPA Nine Minimum Controls and Massachusetts NPDES permits, implying chronic infrastructure problems (groundwater infiltration, illicit connections, pump failures) independent of storms. The modest correlation between rainfall and discharge volume — coupled with the persistence of dry-weather events — suggests that factors beyond storm intensity drive Massachusetts's CSO burden. This could reflect: (1) fundamental differences in system dynamics compared to other case studies, (2) the limitations of this dataset or analysis, or (3) the importance of pipe age and infiltration from other sources alongside rainfall inflow. Clarifying these mechanisms would be valuable for infrastructure planning and climate adaptation.
