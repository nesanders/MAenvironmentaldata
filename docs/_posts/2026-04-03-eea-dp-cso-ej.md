...
On days following dry conditions (less than 0.05 inches in the prior 48 hours), there is roughly a 12% chance of having any discharge statewide. The rate of discharge grows steeply and monotonically with rainfall: across all days with at least 0.05 inches in the prior 48 hours, the chance of a discharge somewhere in the state is ~60%, rising to about 90% on heavy-rainfall days (0.75–1.5 inches) and essentially 100% on very heavy days (>1.5 inches).

The 48-hour accumulation window was chosen because CSO systems respond to conditions created by cumulative rainfall — soil saturation, groundwater recharge, and pipe storage filling. Bizer & Kirchhoff ([2022, *Water Science & Technology*](https://iwaponline.com/wst/article/86/11/2848/91816/Regression-modeling-of-combined-sewer-overflows-to)) found that CSOs in their Maryland case study were optimally paired with rainfall events identified over a 48-hour lookback window. Because most cooperative weather stations observe in the morning and attribute the preceding ~24 hours of rain to the observation day, the daily precipitation series is shifted back one day before computing the lookback window, aligning each discharge event with the physical days of rainfall that preceded it.
...
The y-axis is on a logarithmic scale to spread the large dynamic range of discharge volumes. Discharge volumes tend to increase with rainfall severity (Spearman ρ ≈ 0.5 across the (day, discharge type) pairs shown), though with a large dynamic range at every rainfall level. While SSO events tend to have limited total volume (often less than a million gallons), they are more associated with very heavy rainfall days, indicating that extreme [stormwater inflow](https://en.wikipedia.org/wiki/Infiltration_and_inflow) is a primary cause of Massachusetts SSOs. 
...
**Rainfall strongly predicts discharge occurrence, and the small residue of dry-weather discharges warrants investigation.** Once daily precipitation records are aligned to the physical day of rainfall, the chance of a discharge somewhere in the state rises monotonically from roughly 12% on dry days to essentially 100% on very heavy rainfall days (>1.5 inches over the prior 48 hours), and discharge volumes correlate with rainfall severity. This is consistent with stormwater inflow as the dominant driver of Massachusetts's CSO burden, matching behavior reported in other CSO systems. A small residual of apparent dry-weather events remains (119 reports across 66 days over three and a half years). These events violate EPA Nine Minimum Controls and Massachusetts NPDES permits and imply chronic infrastructure problems (groundwater infiltration, illicit connections, pump failures) independent of storms — though most involve a single reporting municipality, so some may reflect localized rainfall missed by the statewide station average. Systematically investigating these events would be valuable for enforcement and infrastructure planning.
